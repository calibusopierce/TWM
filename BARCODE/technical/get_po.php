...
$linesStmt = sqlsrv_query($conn, "SELECT POItemID, Category, ItemDescription, Brand, Model, Unit, Condition, QtyOrdered, QtyReceived, UnitCost, ItemBarcode FROM TBL_Technical_PO_Items WHERE POID = ? ORDER BY POItemID ASC", [$poId]);
$lines = [];
if ($linesStmt !== false) {
