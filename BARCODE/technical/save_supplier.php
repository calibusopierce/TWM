...
/**
 * save_supplier.php
 * Handles the "Add New Supplier" form (technical/supplier.php modal).
 * Inserts a row into dbo.TBL_Technical_Supplier. Responds as JSON since
...
// Optional image upload — TBL_Technical_Supplier.Image is an [image]/binary column.
$imageStream = null;
if (isset($_FILES['image']) && $_FILES['image']['error'] === UPLOAD_ERR_OK) {
    $imageStream = fopen($_FILES['image']['tmp_name'], 'rb');
}

$sql = "INSERT INTO TBL_Technical_Supplier
        (SupplierCode, SupplierName, Address, ContactNo, ContactPerson, Department, Category, Status, Image, UpdateDateTime)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, GETDATE())";
