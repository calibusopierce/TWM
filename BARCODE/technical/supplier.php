...
// Live query against dbo.TBL_Technical_Supplier in TradewellDatabase.
// Only "Principal" category, active suppliers show up in this list.
$sql = "SELECT ID, SupplierCode, SupplierName, Address, ContactNo, ContactPerson, Status,
...
<div class="card">
    ...
    <table class="ledger" id="supplierTable">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><?php echo htmlspecialchars($s['ContactPerson'] ?? ''); ?></td>
          <td>
  ...
  <div class="table-footer">
    ...
    <span>TradewellDatabase · dbo.TBL_Technical_Supplier</span>
  </div>
</div>
    ...
    <form id="supplierForm" method="post" enctype="multipart/form-data">
      <div class="modal__body">
        ...
        <div class="field">
          ...
          <input type="text" id="supplierCode" name="supplier_code" placeholder="e.g. EPSON-PH" required>
        </div>

        <div class="field">
          <label for="supplierName">Supplier Name</label>
          <input type="text" id="supplierName" name="supplier_name" placeholder="e.g. Epson Philippines Corp" required>
        </div>

        <div class="field">
          <label for="supplierAddress">Address</label>
          <input type="text" id="supplierAddress" name="address" placeholder="e.g. 123 Industrial Ave, Lucena City">
        </div>

        <div class="field">
          <label for="supplierContactNo">Contact No.</label>
          <input type="text" id="supplierContactNo" name="contact_no" placeholder="e.g. 0917 123 4567">
        </div>

        <div class="field">
          <label for="supplierContactPerson">Contact Person</label>
          <input type="text" id="supplierContactPerson" name="contact_person" placeholder="e.g. Juan Dela Cruz">
        </div>
