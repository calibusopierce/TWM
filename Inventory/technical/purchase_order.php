    ...
    <form id="poForm">
      ...
      <div class="modal__body">
        ...
        <div style="display:grid; grid-template-columns: repeat(3, 1fr); gap: 10px; margin-top:10px;">
          ...
          <div class="field">
            <label for="poItemTrackingMethod">Tracking Method</label>
            <select id="poItemTrackingMethod">
              <option value="Quantity-Based" selected>Quantity-Based</option>
              <option value="Individual Unit Tracking">Individual Unit Tracking</option>
            </select>
          </div>
        </div>
        <div style="margin-top:10px;">
          <button type="button" class="btn btn-primary" id="addPoLineBtn">+ Add to List</button>
          <span class="hint" style="margin-left:8px;">Cost is pulled automatically from what this item was registered at. Individual Unit Tracking generates one barcode per unit on save.</span>
        </div>
          ...
          <table class="ledger" id="poLinesTable">
            <thead>
              <tr>
                ...
                <th>Item</th>
                <th style="width:120px;">Unit Barcode</th>
            ...
            <tbody id="poLinesBody">
              <tr id="poLinesEmptyRow"><td colspan="9"><div class="table-empty">No lines added yet.</div></td></tr>
            </tbody>
            <tfoot>
              <tr>
                <td colspan="8" style="text-align:right; font-weight:600;">Sub Total</td>
